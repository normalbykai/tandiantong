...
public class VerificationResponse {
    @Schema(description = "被核销的业务单号", example = "SO10001ABCDEF123456")
    private final String businessNo;

    @Schema(description = "取餐号", example = "A001")
    private final String pickupNo;

    @Schema(description = "核销后的业务状态", example = "VERIFIED")
    ...
    public static VerificationResponse from(
            VerificationPersistenceService.VerificationResult result) {
