...
public class ServiceResponse {
    ...
    @Schema(description = "支付模式", example = "FREE")
    ...
    private ServiceResponse(ReservationPersistenceService.ServiceResult result) {
        ...
        this.priceCent = result.priceCent();
        this.durationMinutes = result.durationMinutes();
    }

    public static ServiceResponse from(ReservationPersistenceService.ServiceResult result) {
