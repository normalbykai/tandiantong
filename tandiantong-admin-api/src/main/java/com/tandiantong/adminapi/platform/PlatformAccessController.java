...
public class PlatformAccessController {
    ...
    public void resetPassword(@PathVariable("userId") Long userId, @Valid @RequestBody PasswordRequest request) { service.resetPassword(current(), userId, request.password); }
